...
const PROJECTS_URL = process.env.REACT_APP_API_URL || 'http://13.60.174.101:5000/api/projects/';
...
const CONTACT_URL = `${API_ROOT}/contact`;
...
export const sendMessage = (data) => axios.post(CONTACT_URL, data);
